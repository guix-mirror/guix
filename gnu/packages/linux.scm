...
(define-public linux-libre-5.10-version "5.10.9")
...
(define-public linux-libre-5.10-pristine-source
  (let ((version linux-libre-5.10-version)
        (hash (base32 "0la7dklpy6xd79fkzavpmlfyrc60kmmwz491msd95dmvv06kwwvz")))
...
(define-public linux-libre-5.4-version "5.4.91")
...
(define-public linux-libre-4.19-version "4.19.169")
...
(define-public linux-libre-4.19-pristine-source
  (let ((version linux-libre-4.19-version)
        (hash (base32 "156y4ly7qyy5z7sbp2vccrs7za72k3zi2hfjpskqqd6civdlvln7")))
    (make-linux-libre-source version
                             (%upstream-linux-source version hash)
                             deblob-scripts-4.19)))

(define-public linux-libre-4.14-version "4.14.216")
...
(define-public linux-libre-4.9-version "4.9.252")
