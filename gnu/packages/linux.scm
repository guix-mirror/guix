...
;; version.
(define-public linux-libre-5.8-version "5.8.12")
...
(define-public linux-libre-5.8-pristine-source
  (let ((version linux-libre-5.8-version)
        (hash (base32 "0lla7zqan5cv5mp591f4ii3blijk3j0mm48y6hcz3irzwsjmmzq2")))
...
(define-public linux-libre-4.19-version "4.19.148")
...
(define-public linux-libre-4.19-pristine-source
  (let ((version linux-libre-4.19-version)
        (hash (base32 "0nsmcfyi6drlihj8i8knby4hl93120sx2dfybx4lwvffjd5cf21k")))
    (make-linux-libre-source version
                             (%upstream-linux-source version hash)
                             deblob-scripts-4.19)))
